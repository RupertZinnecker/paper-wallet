function generateBitcoinKeyPair() {
	...
	// Private key
	var privkeyAndVersion = "0x80" + privkey.substring(2);
	...
	var pubkeyAndVersion = "0x00" + sjcl.codec.hex.fromBits(pubRIPEMD);
	...
	pubkey = sjcl.codec.hex.fromBits(pubkeyAndVersion).substring(2).toUpperCase() + checksum;
	pubkey = "1" + hexToBase58(pubkey);
